...
class testingBM:
    ...
    def test1(self):
        ...
        if buf[0].referenced == 1 and buf[1].referenced == 0 and buf[2].referenced == 1 and buf[3].referenced == 1 and buf[4].referenced == 0:
    ...
    def test5(self):
        ...
        print("Requires pinning the first five pages (600 to 604), then pinning the second five pages (605 to 609), then pinning the eleventh page (page #610)")
        print("")
